...
public class UserController {
	...
	public String addUser(@ModelAttribute User user) {
		...
		//checking if mail as entered in registration form is present in DB or not.
		boolean status=serviceImpl.emialExists(email);
		...
		//sSystem.out.println(user.getUsername()+" "+user.getEmail()+" "+user.getPassword()+" "+user.getGender()+" "+user.getRole()+" "+user.getAddress());
		return "login";
